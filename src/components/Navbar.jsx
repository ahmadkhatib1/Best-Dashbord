...
const Navbar = () => {
  const {
    activeMenu, setActiveMenu, isClicked, setIsClicked, handelClick, screenSize, setScreenSize, currentColor
  } = useSateContext();
  //use//////////////////////////////////////////////////////////////// 
  useEffect(() => {
    const handelResize = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex">
        ...
        <NavButton title="Notification" dotColor="rgb(254, 201, 15)" customFunc={() => handelClick('notification')} color={currentColor} icon={<RiNotification3Line />} />
